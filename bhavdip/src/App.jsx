...
const HotelCard = ({
  ...
  return (
    <div
      className="card hotel-card border-0 shadow rounded-4 overflow-hidden"
      style={{ width: '320px' }}
    >
      <div className="position-relative">
        ...
        {/* Rating Badge */}
        <div
          className="position-absolute bottom-0 end-0 bg-dark bg-opacity-75 text-white px-3 py-2 rounded-start"
